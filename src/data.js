...
import btn_img_2 from './assets/work/2.webp';
import btn_img_3 from './assets/work/3.webp';
...
import bienstone from './assets/partner/bienstone.webp';
import caesa from './assets/partner/caesa.webp';
import corian from './assets/partner/corian.webp';
import hanex from './assets/partner/hanex.webp';
...
import radianz from './assets/partner/radianz.webp';
import tristone from './assets/partner/tristone.webp';
import vicostone from './assets/partner/vicostone.webp';
export const lang = {
	ua: {
		homeData: {
		...
		aboutData: {
			text: {
				...
				descrText: [
					...
					'- Підвіконня з натурального та штучного каменю',
					'- Мармурові і гранітні сходи',
					'- Барні стійки з граніту і мармуру',
				],
			},
		},
		materialData: {
		...
		menuNavSlider: ['На головну', 'Наші роботи'],
		title: 'Rich Stone - вироби із каменю, граніту, мармуру.',
		...
		contactsAdres: 'Днiпро, вул. Берегова 135',
	},
	ru: {
		homeData: {
			text: 'Вся роскошь и благородство натурального камня!',
		},
		aboutData: {
			text: {
				title:
				...
				descrText: [
					...
					'- Мраморная и гранитная лестница',
					'- Барные стойки из гранита и мрамора',
				],
			},
		},
		materialData: {
		...
		menuNavHref: ['/#about', '/#work', '/#partners', '/#materials', '/#contacts'],
		menuNavSlider: ['На главную', 'Наши работы'],
		title: 'Rich Stone – изделия из камня, гранита, мрамора.',
		sliderBtns: [
